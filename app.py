...
NEGATIVE_WORDS = [ 
    ...
    "がっかり", "裏切り", "嘘", "詐欺", "犯罪", "違法",
    # 攻撃系
    "きもい", "キモい", "気持ち悪い", "うざい", "ウザい", "嫌い", "大嫌い", 
    "バカ", "馬鹿", "アホ", "クズ", "ゴミ", "頭おかしい", "頭悪い","謝罪まだ？","説明しろ",
    # 不信・批判系
    "やばい", "ヤバい", "無理", "無理だろ", "意味不明", "理解できない", "信用できない", "信じられない", 
    "不快", "寒い", "痛い","逃げるな",
    # ネガティブ評価
    "つまらない", "面白くない", "微妙", "ショック", "残念", "ひどすぎる",
    # 炎上ワード頻出
    "釣り", "炎上商法", "アンチ", "批判", "問題発言", "問題ある",
    # 呆れ系
    "終わってる", "もういい", "見るのやめる", "登録解除", "チャンネル登録解除",
